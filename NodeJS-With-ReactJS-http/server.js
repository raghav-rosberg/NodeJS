var http = require('http');
    ...
    React = require('react'),
    DOM = React.DOM, body = DOM.body, div = DOM.div, script = DOM.script, AppUrl = '/samplenode/nodeapp'
...
http.createServer(function (req, res) {
  ...
  if (req.url == AppUrl) {
    ...
    var html = React.renderToStaticMarkup(body(null,
      ...
      //   '$(document).ready(function(){alert("' + req.url + '");});'
      //}}),
  ...
  } else if (req.url == AppUrl + '/bundle.js') {
